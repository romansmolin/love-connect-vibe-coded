                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <div className="space-y-8">
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                We collect only the minimum data necessary to operate and improve the Service. The
                                information we collect falls into a few categories:
                            </p>
                            ...
                            <p className="mb-4">
                                ...
                                needed to process your subscription.
                            </p>
                            ...
                            <p className="mb-4">
                                ...
                                your profile name and ID, and any content or data that you explicitly ask us to
                                fetch or manage. For example:
                            </p>
                            ...
                            <ul className="list-disc pl-6 space-y-2 mb-4">
                                ...
                                <li>
                                    ...
                                    or username on each platform, and profile picture URL).
                                </li>
                            </ul>

                            <p className="mb-4">
                                We do not collect all data from your social accounts – only what is needed to
                                provide our service features. For instance, we will not download your private
                                messages, friends list, or other unrelated personal data. We also do not collect
                                sensitive personal data from social networks that is not required for our
                                functionality. In summary, we retrieve only the required info needed to publish
                                your posts and display basic info about your linked social accounts, and nothing
                                more (data minimization principle).
                            </p>
                            ...
                            <ul className="list-disc pl-6 space-y-2 mb-4">
                                <li>
                                    <strong>Log Data:</strong> Information about your interactions with our
                                    Service, such as the pages or screens you visit, the times and dates of your
                                    visits, features used, and errors or performance metrics.
                                </li>
                                <li>
                                    <strong>Device/Browser Information:</strong> Your IP address, browser type,
                                    device type, operating system, and hardware model. This information helps us
                                    troubleshoot issues and improve compatibility across devices.
                                </li>
                                <li>
                                    <strong>Cookies and Similar Technologies:</strong> We use cookies or similar
                                    tracking technologies to remember your login session and preferences, and to
                                    collect analytics about how users in general navigate our site. For example, we
                                    may use a cookie to keep you logged in during a session or to understand which
                                    features are most popular. You can control cookies through your browser
                                    settings, but note that disabling certain cookies may affect functionality
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                Usage and device data help us understand how the Service is performing and how
                                users are interacting with it. We analyze this data (often in aggregate form) to
                                debug issues, optimize our user interface, and plan new features. This usage data
                                is generally de-identified or aggregated, and not used to profile individuals for
                                marketing.
                            </p>

                            <h3 className="text-xl font-medium mb-3">Communications</h3>
                            <p className="mb-4">
                                We may use your email address to send you service-related notifications (for
                                example, a confirmation of a scheduled post, important updates about the platform,
                                changes to these policies, security alerts, or customer support responses). We may
                                also send occasional product announcements, newsletters, or offers, but you will
                                have the ability to opt-out of marketing emails if you don&apos;t want to receive
                                them.
                            </p>
                            ...
                            <div className="bg-green-50 border-l-4 border-green-400 p-4">
                                <p className="text-sm">
                                    <strong>Important:</strong> We do not sell your personal information to third
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                We use reputable third-party service providers to host our servers and database,
                                process payments, send emails, and provide certain functionalities. For instance,
                                our servers may be hosted on a cloud platform like Amazon Web Services or Google
                                Cloud, and we use a payment gateway to handle billing. These providers may have
                                access to personal data only to perform tasks on our behalf (e.g., storing data,
                                processing transactions, or sending emails) and are contractually obligated to
                            ...
                            <p className="mb-4">
                                ...
                                valid requests by public authorities (e.g., a court order, subpoena, or government
                                demand). We will attempt to notify you of such requests when allowed, and will only
                                disclose what is lawfully required.
                            </p>
                            ...
                            <p className="mb-4">
                                ...
                                have made in this Privacy Policy or provide you notice and an opportunity to opt
                                out of the transfer of your personal information.
                            </p>

                            <h3 className="text-xl font-medium mb-3">With Your Consent</h3>
                            <p className="mb-4">
                                In cases where you have given us explicit consent to share your information with a
                                third party (for example, if we introduce a feature where you can opt in to
                                integrate another partner service), we will share it as directed by you.
                            </p>

                            <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                                <p className="text-sm">
                                    <strong>Important:</strong> We do not share or disclose your social media
                                    content or account data to any third parties other than the social networks
                                    themselves and our necessary service providers. We do not provide advertisers
                                    or unrelated parties access to your linked account data or post content. Any
                                    data we share with telemetry or error tracking services is typically
                                    pseudonymized or aggregated to protect your identity.
                                </p>
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                ...
                                outlined in this policy or as required by law. Concretely:
                            </p>
                            ...
                            <p className="mb-4">
                                We generally retain logs and aggregated usage data for a shorter period (e.g.,
                                12-24 months) for troubleshooting and analytics. These logs may include IP
                                addresses or device IDs, but we treat them as confidential and protect them like
                                any personal data. Once they are no longer needed, we either delete or anonymize
                                this data.
                            </p>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                We take security seriously and implement commercially reasonable measures to
                                protect your information from unauthorized access, alteration, disclosure, or
                                destruction. Some of the security practices we follow include:
                            </p>
                            ...
                            <p className="mb-4">
                                When you connect your social media accounts, we use OAuth protocols. This means we
                                do not store your social media login passwords. Instead, you authorize us with
                                tokens issued by the platforms, which can be individually revoked by you.
                            </p>

                            <h3 className="text-xl font-medium mb-3">Access Controls</h3>
                            <p className="mb-4">
                                Within our organization, personal data is accessible only to those team members who
                                need it to perform their duties (principle of least privilege). Administrative
                                access to systems that store personal data is logged and audited.
                            </p>

                            <h3 className="text-xl font-medium mb-3">Monitoring and Testing</h3>
                            <p className="mb-4">
                                We monitor for suspicious activities and have systems in place to detect and
                                respond to potential security incidents. We periodically review our practices and
                                may employ third-party security audits or penetration testing services to evaluate
                                our defenses.
                            </p>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                ...
                                California&apos;s CCPA, etc.), you may have certain rights regarding your personal
                                data. We honor applicable data subject rights requests and provide similar controls
                                to all users as a matter of good practice. These rights may include:
                            </p>

                            <h3 className="text-xl font-medium mb-3">Access and Portability</h3>
                            <p className="mb-4">
                                You can request a copy of the personal data we hold about you, and information on
                                how it&apos;s used. We can provide this in a machine-readable format. Much of your
                                data (posts and profile info) is available directly in your account dashboard, but
                                you can also contact us for a full export.
                            </p>

                            <h3 className="text-xl font-medium mb-3">Correction</h3>
                            <p className="mb-4">
                                If any personal information we have is inaccurate or outdated, you have the right
                                to request a correction. You can update some of your account information directly
                                in your profile settings, or reach out to us for help.
                            </p>

                            <h3 className="text-xl font-medium mb-3">Deletion</h3>
                            <p className="mb-4">
                                You have the right to request deletion of your personal data. As noted above, you
                            ...
                            <p className="mb-4">
                                You have the right to object to or ask us to limit (restrict) processing of your
                                data under certain circumstances – for example, you can ask that we stop using your
                                data for marketing emails (which we will honor by opting you out). If you have
                                concerns about any other form of processing, let us know and we will review and
                                accommodate if required.
                            </p>

                            <h3 className="text-xl font-medium mb-3">Consent Withdrawal</h3>
                            <p className="mb-4">
                                If you have given consent to any optional data processing (for instance, if in the
                                future we seek your consent for something like sharing info with a partner), you
                                can withdraw that consent at any time for future processing. Withdrawing consent
                                will not affect the legality of what we did with your data before you withdrew.
                            </p>

                            <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                                <p className="text-sm">
                                    <strong>To exercise any of these rights:</strong> Please contact us (see
                                    Contact Us below). We may need to verify your identity to process certain
                                    requests. We will respond to your request within a reasonable timeframe and in
                                    accordance with applicable law. There is no charge for making a request, but
                                    repetitive or excessive requests may incur a fee as permitted by law. If you
                                    are an EU/EEA user and believe we have not adequately addressed your data
                                    rights concerns, you have the right to lodge a complaint with your
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                ...
                                we adopt global infrastructure. Regardless of where data is stored, we apply the
                                same privacy protections described in this policy.
                            </p>

                            <p className="mb-4">
                                When we transfer personal data out of regions with data transfer restrictions (like
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                practices, technologies, legal requirements, or for other operational reasons. When
                                we make changes, we will notify you by updating the &quot;Last Updated&quot; date
                        ...
                        <section>
                            ...
                            <div className="bg-muted p-4 rounded-lg">
                                ...
                                <p className="mt-2 text-sm text-muted-foreground">
                                    ...
                                    safeguarding your privacy while providing a valuable service.
                                </p>
                            </div>
                        </section>
                    </div>
