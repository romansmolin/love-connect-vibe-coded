        ...
        <div className="min-h-screen bg-background mt-28">
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                <div className="prose prose-lg max-w-none">
                    <h1 className="text-4xl font-bold mb-8 text-center">LoveConnect Terms and Conditions</h1>
                    ...
                    <div className="space-y-8">
                        <section>
                            <p className="mb-6">
                                Welcome to LoveConnect, a service that enables you to schedule and manage social
                                media posts across multiple platforms. By accessing or using LoveConnect (the
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                To use LoveConnect, you must create an account with accurate and up-to-date
                            ...
                            <p>
                                ...
                                jurisdiction) to use LoveConnect. If you are using LoveConnect on behalf of an
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                LoveConnect may offer both free and paid subscription plans (e.g., Free, Standart,
                            ...
                            <p className="mb-4">
                                ...
                                beforehand. By providing a payment method, you authorize LoveConnect to charge the
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                LoveConnect allows you to create, schedule, and publish content (&quot;User
                                Content&quot;) to your connected social media accounts. You retain ownership of all
                                User Content you post through our Service. By using LoveConnect to publish or
                                schedule content, you grant us a limited license to access, process, and transmit
                                your content as necessary to provide the Service (for example, to format and send
                                your posts to the selected social media platforms). This license is solely for the
                            ...
                            <p className="mb-4">
                                You agree to use LoveConnect only for lawful purposes and in compliance with these
                            ...
                            <p className="mb-4">
                                ...
                                your LoveConnect account (see Termination below), and may also expose you to legal
                                consequences.
                            </p>
                            ...
                            <p className="mb-4">
                                ...
                                limits apply anywhere you use the LoveConnect composer or media uploader, unless a
                            ...
                            <ul className="list-disc pl-6 space-y-2 mb-4">
                                ...
                                <li>
                                    ...
                                    LoveConnect uploader. We recommend H.264 video with AAC audio for best
                                    compatibility.
                                </li>
                                <li>
                            ...
                            <p className="mb-4">
                                Because LoveConnect connects to external social media platforms, you agree to
                                comply with each social platform&apos;s own terms and policies when using our
                                Service. This means that all content you post and actions you take through
                                LoveConnect must also adhere to the rules of the platform to which you are posting.
                            </p>
                            ...
                            <p className="mb-4">
                                ...
                                connect to LoveConnect. If you violate a social platform&apos;s terms, that
                                platform may take action against your account independently of LoveConnect, and
                                LoveConnect is not responsible for your violations on third-party services.
                            </p>

                            <h3 className="text-xl font-medium mb-3">No Affiliation</h3>
                            <p>
                                LoveConnect is an independent service. We are not affiliated with, endorsed, or
                                ...
                                Use of such marks in LoveConnect is for identification purposes only and does not
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                To enable LoveConnect to post on your behalf, you will connect your social media
                                accounts via OAuth 2.0 authentication. When you connect an account, you grant
                                LoveConnect permission to access certain information and perform actions (for
                                example, publishing posts) as allowed by that platform&apos;s API. You can revoke
                                our access at any time via the settings of the respective social media platform.
                                LoveConnect does not collect your social media login passwords; authentication is
                                handled securely by the platforms (we receive tokens, not credentials).
                            </p>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                LoveConnect (including our software, website, and all content we create, such as
                                text, graphics, logos, and compilations) is protected by intellectual property
                                laws. We grant you a limited, revocable, non-exclusive, non-transferable license to
                                use LoveConnect for its intended purpose, subject to these Terms. You may not copy,
                                distribute, modify, or create derivative works from our Service except as
                                explicitly allowed by us or by law. All LoveConnect trademarks, logos, and service
                            ...
                            <p>
                                You retain all rights to the content you create and upload to LoveConnect (your
                                &quot;User Content&quot;). LoveConnect does not claim ownership of your User
                                Content. By submitting or scheduling content through our Service, you grant
                                LoveConnect the right to store, transmit, display, and otherwise use your content
                                solely as needed to provide the Service (for example, to post it on the social
                                networks at your direction or to generate previews). This license is worldwide,
                                non-exclusive, and royalty-free, and it ends when you delete the content from our
                                systems or when you terminate your LoveConnect account. Please ensure you have the
                                necessary rights to any content you post (including permissions for any copyrighted
                                material) – you should not upload content to LoveConnect that you do not have the
                                right to use or share.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                information through LoveConnect is explained in our Privacy Policy. By using the
                                Service, you agree that we can collect and use your information in accordance with
                                the Privacy Policy. In particular, by connecting LoveConnect to your social media
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                LoveConnect is provided on an &quot;as is&quot; and &quot;as available&quot; basis.
                                ...
                                LoveConnect&apos;s control. We disclaim all warranties, express or implied,
                            ...
                            <p className="mb-4">
                                LoveConnect primarily acts as an intermediary between you and the social media
                                ...
                                policies against you, and you use LoveConnect at your own risk with respect to
                                third-party services.
                            </p>

                            <h3 className="text-xl font-medium mb-3">Limitation of Liability</h3>
                            <p>
                                To the fullest extent permitted by law, in no event will LoveConnect or its parent
                                ...
                                liability of LoveConnect to you exceed the amount that you paid us (if any) for the
                        ...
                        <section>
                            ...
                            <p>
                                You agree to indemnify, defend, and hold harmless LoveConnect and its affiliates,
                                and each of their respective officers, directors, agents, and employees, from any
                                and all claims, liabilities, damages, losses, and expenses (including reasonable
                                ...
                                your use of LoveConnect. We reserve the right to assume the exclusive defense and
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                You may stop using LoveConnect and/or close your account at any time. If you wish
                                to delete your account and all associated data, you can do so through the account
                            ...
                            <p>
                                We reserve the right to suspend or terminate your access to LoveConnect at any
                                time, with or without notice, for any of the following reasons: (i) if you breach
                                these Terms or our Privacy Policy; (ii) if you engage in prohibited conduct or
                                violate the Social Network TOS listed above; (iii) if required by law enforcement
                                or government request; or (iv) for any other reason in our sole discretion (for
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                indicate the effective date of the updated Terms. By continuing to use LoveConnect
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                jurisdiction where LoveConnect&apos;s owning company is established (unless
                                otherwise required by the laws of your country of residence). We will notify you of
                                the specific governing jurisdiction here once our company registration details are
                                finalized.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="bg-muted p-4 rounded-lg mt-4">
                                <p className="font-medium">LoveConnect Support</p>
                                <p>Email: support@LoveConnect.com</p>
                                <p>
                                    Website:{' '}
